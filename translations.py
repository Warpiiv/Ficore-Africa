translations = {
    ...
    'Hausa': {
        ...
        'Failed to send email due to server issue': 'An kasa aika imel saboda matsalar uwa',
        ...
        'Great job! Continue to leverage your {personality} approach to build wealth.': 'Aiki mai kyau! Ci gaba da yin amfani da hanyar {personality} don gina arziki.',
        'Good effort! Your {personality} style is solid, but consider tracking expenses more closely.': 'Ƙoƙari mai kyau! Salon {personality} ɗinka yana da ƙarfi, amma ka yi la’akari da bibiyar kashe kuɗi da kyau.',
        'Keep learning! Your {personality} approach can improve with regular financial reviews.': 'Ci gaba da koyo! Hanyar {personality} ɗinka za ta iya inganta tare da duba kuɗi akai-akai.'
    }
}

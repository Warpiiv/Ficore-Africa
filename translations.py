translations = {
    'English': {
        ...
        'Financial Guru': 'Financial Guru',
         'Personal Information': 'Personal Information',  # Keep for reference, but prefer 'Your Personal Info'
        'Your Personal Info': 'Your Personal Info',
        'Monthly Budget Planner': 'Monthly Budget Planner',  # Keep for reference, but prefer 'Plan Your Monthly Finances'
    ...
    'Hausa': {
        ...
        'Urgent Attention Needed': 'Kuɗin ku na buƙatar kulawa cikin gaggawa. Nemi shawarar ƙwararru kuma bincika hanyoyin farfadowa.',
        ...
        'First Name Required': 'Ana buƙatar sunan farko.',
                'Your Financial Health Dashboard': 'Dashboard na Lafiyar Kudin Ku',
        'Financial Health Score': 'Makin Lafiyar Kudi',
        'Financial growth passport for Africa': 'Gajiyar Ci Gaban Kudi ta Afirka',
        'Welcome': 'Barka da Zuwa',
        'Your Financial Health Summary': 'Takaitaccen Lafiyar Kudin Ku',
        'Score': 'Maki',
        'Advice': 'Shawara',
        'Rank': 'Matsayi',
        'out of': 'daga cikin',
        'users': 'masu amfani',
        'Your Badges': 'Alamun Ku',
        'No Badges Yet': 'Babu Alamu Har Yanzu',
        'Recommended Learning': 'Koyarwa da ake Ba da Shawara',
        'Whats Next': 'Me ne Ake Bukata A Gaba',
        'Back to Home': 'Komawa Gida',
        'Provide Feedback': 'Bada Ra\'ayi',
        'Join Waitlist': 'Shiga Jerin Jira',
        'Book Consultancy': 'Shirya Shawarwari',
        'Share Your Results': 'Raba Sakamakon Ku',
        'My Financial Health Score': 'Makin Lafiyar Kudi Ta Ni',
        'Ranked': 'An Sanya Matsayi',
        'Check yours at': 'Duba naku a',
        'Results copied to clipboard': 'An kwafa sakamako zuwa allo',
        'Failed to copy results': 'Rashin kwafa sakamako',
        'Contact Us': 'Tuntuɓar Mu',
        'Click to Email': 'Danna don Imel',
        'for support': 'don tallafi',
        'Get Your Score': 'Samu Makin Ku',
        'Calculate Your Financial Health Score': 'Ƙididdige Makin Lafiyar Kudin Ku',
        'Personal Information': 'Bayanan Sirri',
        'Financial Information': 'Bayanan Kudi',
        'First Name Required': 'Ana bukatar Suna na farko',
        'Invalid Email': 'Imel mara inganci',
        'Language selected!': 'Harshe an zaɓa!',
        'Next': 'Na gaba',
        'Previous': 'Na baya',
        'Submit': 'Ɗora',
        'Analyzing your score...': 'Ana nazarin makin ku...',
        'Home': 'Gida',
        'Dashboard': 'Dashboard',
        'Total money you receive regularly, like salary, business sales, gifts, grants, incentives, or side hustles.': 'Jimlar kuɗin da kuke samu akai-akai, kamar albashi, tallace-tallace na kasuwanci, kyautai, tallafi, ƙarfafawa, ko ayyukan ƙarin kuɗin shiga.',
        'All the money you spend, such as on rent, food, transport, electricity bill, gas and utilities, fine and penalties, levies, taxes, etc.': 'Duk kuɗin da kuke kashewa, kamar haya, abinci, sufuri, lissafin wutar lantarki, iskar gas da kayan aiki, tara da hukunci, haraji, da sauransu.',
        'Money you owe, like loans, IOUs, borrowings, or funds lent to you.': 'Kuɗin da kuke bashi, kamar lamuni, IOUs, rancen, ko kuɗin da aka ba ku.',
        'New to finances? Click here to get guided tips on how to fill this form.': 'Babu sabon kuɗin ku? Danna nan don samun jagororin jagora kan yadda ake cike wannan fom.',
        'Getting Started with Ficore Africa': 'Fara Aiki da Ficore Africa',
        'Looks good!': 'Yayi kyau!',
        'Valid amount!': 'Adadin inganci!',
        'Invalid Number': 'Lamba mara inganci',
        'Form validation failed. Please check your inputs.': 'Gwajin fom ya gaza. Da fatan a duba abubuwan da kuka shigar.',
        'Internal server error': 'Kuskuren sabar cikin gida',
        ...
        'Personal Information': 'Bayanin Mutum',  # Keep for reference
        'Your Personal Info': 'Bayanin Mutum Na Keɓaɓɓen Ka',
        'Monthly Budget Planner': 'Mai Tsara Kasafin Kuɗi na Wata',  # Keep for reference
        'Plan Your Monthly Finances': 'Shirya Kuɗin Ka na Wata',
        'Select': 'Zaɓi',
        'Yes': 'Eh',
        'No': 'A’a',
        'Question': 'Tambaya',
        ...
        'Do you save some money every month?': 'Shin kana adana wasu kuɗi kowane wata?',
        'Do you know how much you spend each week?': 'Shin ka san adadin da kake kashewa kowane mako?',
        'Do you like to plan before spending money?': 'Shin kana son shiryawa kafin kashe kuɗi?',
        ...
        'Do you avoid borrowing money when possible?': 'Shin kana guje wa ɗaukar bashi idan zai yiwu?',
        'Do you feel okay taking small money risks?': 'Shin kana jin daɗin ɗaukar ƙananan haɗarin kuɗi?',
        'Do you learn about saving or investing?': 'Shin kana koyon tanadi ko saka hannun jari?',
        'Do you spend less than you earn?': 'Shin kana kashe ƙasa da abin da kake samu?',
        'Do you talk about money with family or friends?': 'Shin kana tattaunawa game da kuɗi tare da dangi ko abokai?',
        'Dashboard': 'Dashboard',

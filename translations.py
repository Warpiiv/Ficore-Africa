translations = {
    ...
    'Hausa': {
        ...
        'Financial Growth Tools': 'Kayan Aikin Ci Gaban Kuɗi',
        'Change Language': 'Canza Harshe',
        'Go': 'Tafi',
        'Discover Your Financial Tools Below': 'Gano Kayan Aikin Kuɗin Ka a ƙasa',
        'New here? Start with your Financial Health Score to get personalized recommendations.': 'Sabon shiga nan? Fara da Makin Lafiyar Kuɗin Ka don samun shawarwari na keɓaɓɓu.',
        'Begin Financial Health Score Assessment': 'Fara Tantance Makin Lafiyar Kuɗi',
        'Begin Now': 'Fara Yanzu',
        'Track Your Finances': 'Biyi Kuɗin Ka',
        'Start Financial Health Score Assessment': 'Fara Tantance Makin Lafiyar Kuɗi',
        'Start Now': 'Fara Yanzu',
        'Start Here': 'Fara Nan',
        'Calculate your net worth from assets and liabilities': 'Lissafa darajar dukiyarka daga kadarori da basussuka',
        'Start Net Worth Calculator': 'Fara Kalkuletar Darajar Dukiya',
        'Start Emergency Fund Calculator': 'Fara Kalkuletar Kuɗin Gaggawa',
        'Plan & Budget': 'Shirya & Kasafi',
        ...
        'Allocate income across expense categories': 'Raba kuɗin shiga a cikin nau’ikan kashe kuɗi',
        'Start Weekly Budget Planner': 'Fara Mai Tsara Kasafin Mako-mako',
        'Track expenses by category and date': 'Biyi kashe kuɗin ka ta rukuni da kwanan wata',
        'Log and edit expenses for spending insights': 'Shigar da kuma gyara kashe kuɗin don fahimtar kashe kuɗi',
        'Start Expense Tracker': 'Fara Mai Bibiyar Kashe Kuɗi',
        'Organize bills by amount and due date': 'Tsara kuɗin biyan kuɗi ta adadi da kwanan biya',
        'Manage and mark bills as paid': 'Sarrafa kuma alama kuɗin biyan kuɗi a matsayin an biya',
        'Start Bill Planner': 'Fara Mai Tsara Kuɗin Biyan Kuɗi',
        ...
        'Daily Tip: Pay yourself first before expenses': 'Shawara ta Yau: Biyan kanka da farko kafin kashe kuɗi',
        'Feature Spotlight: Try our Net Worth Calculator!': 'Fitowar Fasali: Gwada Kalkuletar Darajar Dukiyarmu!',
        'Go Back': 'Koma Baya',

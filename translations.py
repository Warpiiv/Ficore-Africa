translations = {
    'English': {
        ...
        'Form validation failed. Please check your inputs.': 'Form validation failed. Please check your inputs.',
        ...
        'Manage income and expenses with a budget': 'Manage income and expenses with a budget',
    ...
    'Hausa': {
        ...
        'users': 'masu amfani',
        'Strong Financial Health': 'Makin ku yana nuna lafiyar kuɗi mai ƙarfi. Mai da hankali kan saka hannun jari don haɓaka arzikin ku.',
        'Stable Finances': 'Kuɗin ku na da kwanciyar hankali amma yana iya inganta. Yi la’akari da tanadi ko rage kashe kuɗi.',
        'Financial Strain': 'Makin ku yana nuna matsin kuɗi. Ba da fifiko kan biyan bashin ku da sarrafa kashe kuɗi.',
        'Urgent Attention Needed': 'Kuɗin ku na buƙatar kulawa cikin gaggaga. Nemi shawarar ƙwararru kuma bincika hanyoyin farfadowa.',
        'Score Breakdown': 'Rarraba Maki',
        'Chart Unavailable': 'Chart ba ya samuwa a wannan lokacin.',
        'Asset-Liability Breakdown': 'Rarraba Kadara da Basussuka',
        ...
        'Form validation failed. Please check your inputs.': 'Binciken fom ya kasa. Don Allah duba abubuwan da ka shigar.',
        ...
        'Emergency Fund Email Body': '''
            ...
            <body style="font-family: Arial, sans-serif; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
                ...
                <ul>
                    <li><strong>Kashe Kuɗi na Wata</strong>: ₦{monthly_expenses}</li>
                ...
                <p>Bi shawarar da ke sama don ƙarfafa amincin kuɗin ka.</p>
                <p style="margin-bottom: 10px;">
                    Kana son ƙarin koyo? Duba wannan kwas: 
                    <a href="{course_url}" style="display: inline-block; padding: 10px 20px; background-color: #FBC02D; color: #333; text-decoration: none; border-radius: 5px; font-size: 0.9rem;">{course_title}</a>
                </p>
        ...
        'Net Worth Email Body': '''
            ...
            <body style="font-family: Arial, sans-serif; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
                ...
                <ul>
                    ...
                    <li><strong>Matsayi</strong>: {rank}% (Sama da {top_percent}%)</li>
                    <li><strong>Shawara</strong>: {advice}</li>
                </ul>
        ...
        'Discover your financial personality and gain insights': 'Gano halin kuɗin ka kuma sami fahimta game da halayen kuɗin ka.',
        ...
        'Provide your email address to receive your results and personalized tips.': 'Ba da adireshin imel ɗinka don karɓar sakamakon ka da shawarwari na keɓaɓɓu.',
        ...
        'Answer each question with Yes or No based on your financial habits.': 'Amsa kowace tambaya da Ee ko A’a bisa ga halayen kuɗin ka.',
        ...
        'Do you regularly track your income and expenses?': 'Shin kana bibiyar kuɗin shiga da kashe kuɗi akai-akai?',
        'Do you prefer saving for the future over spending on immediate desires?': 'Shin ka fi son ajiye kuɗi don gaba fiye da kashewa akan abubuwan da kake so nan da nan?',
        'Are you comfortable with taking financial risks to grow your wealth?': 'Shin kana jin daɗi da ɗaukar haɗarin kuɗi don haɓaka arzikin ka?',
        'Do you have an emergency fund set aside for unexpected situations?': 'Shin kana da asusun gaggawa da aka keɓe don yanayi marasa tsammani?',
        'Do you review your financial goals and strategies regularly?': 'Shin kana duba manufofin kuɗin ka da dabaru akai-akai?',
        'Emergency Fund Calculator': 'Ƙididdigar Asusun Gaggawa',
        'Protect your financial well-being from unexpected events. Calculate your ideal safety net.': 'Kare lafiyar kuɗin ka daga abubuwan da ba a ji ba. Ƙididdige hanyar aminci mafi kyau.',
        'Most experts recommend saving 3-6 months of essential living expenses.': 'Yawancin ƙwararru suna ba da shawarar ajiye kashe kuɗin rayuwa na watanni 3-6.',
        ...
        'Find your safety net amount now!': 'Nemo adadin hanyar amincin ka yanzu!',
        ...
        'Take control of your finances and achieve your goals by creating a monthly budget.': 'Ɗauki iko akan kuɗin ka kuma cimma burinka ta hanyar ƙirƙirar kasafin kuɗi na wata.',
        'Enter your total monthly earnings, including salary and side income.': 'Shigar da jimillar kuɗin shigar ka na wata, gami da albashi da kuɗin gefe.',
        'Include rent, electricity, water, and related housing bills.': 'Haɗa haya, wutar lantarki, ruwa, da lissafin gidaje masu alaƙa.',
        'Estimate how much you spend on food monthly.': 'Ƙididdige nawa kake kashewa akan abinci kowane wata.',
        'Monthly cost of transport—bus, bike, taxi, or fuel.': 'Farashin sufuri na wata—bas, keke, tasi, ko mai.',
        'Include internet, airtime, clothes, or personal spending.': 'Haɗa intanet, kiredit, tufafi, ko kashe kuɗi na kanka.',
        'Get budgeting tips in your inbox.': 'Samu shawarwari kan kasafin kuɗi a cikin akwatin imel ɗinka.',
        ...
        'Track your daily expenses to stay on top of your finances.': 'Bi diddigin kashe kuɗin ka na yau da kullum don kasancewa a saman kuɗin ka.',
        ...
        'Plan and manage your upcoming bills to avoid surprises.': 'Tsara kuma sarrafa kuɗin da ke zuwa don guje wa abubuwan mamaki.',
        ...
        'Access essential tools and insights to understand, manage, and grow your finances across Africa': 'Samun kayan aiki da fahimta masu mahimmanci don fahimta, sarrafawa, da haɓaka kuɗin ka a duk Afirka',
        'Why Ficore Africa?': 'Me yasa Ficore Africa?',
        'Localized for Africa with support for Naira and regional financial contexts': 'An keɓance shi don Afirka tare da tallafi ga Naira da mahallin kuɗi na yanki',
        ...
        'Assess your financial health with a personalized score and insights': 'Tantance lafiyar kuɗin ka tare da makin keɓaɓɓu da fahimta',
        'This tool evaluates your income, expenses, and debt to provide a health score': 'Wannan kayan aiki yana kimanta kuɗin shiga, kashe kuɗi, da bashi don ba da makin lafiya',
        'Get Started with Financial Health Score': 'Fara da Makin Lafiyar Kuɗi',
        'Calculate your net worth by evaluating your assets and liabilities': 'Ƙididdige darajar kuɗin ka ta hanyar kimanta kadarori da basussuka',
        'Net worth is calculated as assets minus liabilities': 'Ana ƙididdige darajar kuɗi a matsayin kadarori ban da basussuka',
        'Get Started with Net Worth Calculator': 'Fara da Ƙididdigar Darajar Kuɗi',
        'Plan your emergency fund to cover unexpected expenses': 'Tsara asusun gaggawa don biyan kashe kuɗin da ba a ji ba',
        'Aims to cover 3-6 months of expenses for financial security': 'Yana nufin rufe kashe kuɗin watanni 3-6 don amincin kuɗi',
        'Get Started with Emergency Fund Calculator': 'Fara da Ƙididdigar Asusun Gaggawa',
        'Test your financial knowledge and get personalized tips': 'Gwada ilimin kuɗin ka kuma sami shawarwari na keɓaɓɓu',
        ...
        'Helps you allocate your income across various expense categories': 'Yana taimaka maka ka raba kuɗin shigar ka a cikin rukunan kashe kuɗi daban-daban',
        'Get Started with Weekly Budget Planner': 'Fara da Mai Tsara Kasafin Kuɗi na Mako',
        ...
        'New here? Start with your Financial Health Score to get personalized recommendations.': 'Sabon ne a nan? Fara da Makin Lafiyar Kuɗin ka don samun shawarwari na keɓaɓɓu.',
        'Begin Financial Health Score Assessment': 'Fara Tantance Makin Lafiyar Kuɗi',
        'Begin Now': 'Fara Yanzu',
        'Track Your Finances': 'Bi Kuɗin Ka',
        ...
        'Start Net Worth Calculator': 'Fara Ƙididdigar Darajar Kuɗi',
        'Start Emergency Fund Calculator': 'Fara Ƙididdigar Asusun Gaggawa',
        ...
        'Track expenses by category and date': 'Bi kashe kuɗi ta rukuni da kwanan wata',
        ...
        'Organize bills by amount and due date': 'Tsara kuɗin da adadi da ranar karewa',
        'Manage and mark bills as paid': 'Sarrafa kuma alama kuɗin a matsayin an biya',
        ...
        'Answer questions to assess financial literacy': 'Amsa tambayoyi don tantance ilimin kuɗin ka',
        'Start Financial Personality Quiz': 'Fara Tambayoyin Halin Kuɗi',
        'Daily Tip: Pay yourself first before expenses': 'Shawarar Yau: Biya kanka da farko kafin kashe kuɗi',
        'Feature Spotlight: Try our Net Worth Calculator!': 'Fitaccen Alama: Gwada Ƙididdigar Darajar Kuɗin Mu!',
        ...
        'Weekly': 'Mako-Mako',
        'Monthly': 'Wata-Wata',
        'No data available': 'Babu bayanai a yanzu. Don Allah ƙaddamar da fom da farko.',
        ...
        'Bill Reminder Subject': 'Tunatarwar Kuɗi: {description}',
        'Bill Reminder Body': '''
            <h1>Tunatarwar Kuɗi</h1>
            <p>Mai girma {first_name},</p>
            <p>Wannan tunatarwa ce ga kuɗin ka: {description}</p>
            <p>Adadi: {amount}</p>
            <p>Ranar Karewa: {due_date}</p>
        ''',
        ...
        'Email reminders not available due to missing scheduler': 'Tunatarwar imel ba ta samuwa saboda rashin mai tsara lokaci',
        ...
        'Your Personal Info': 'Bayanin Kanka',
        ...
        'Do you save some money every month?': 'Shin kana ajiye wasu kuɗi kowane wata?',
        'Do you know how much you spend each week?': 'Shin ka san nawa kake kashewa kowane mako?',
        ...
        'Do you check your money goals often?': 'Shin kana duba manufofin kuɗin ka akai-akai?',
        'Do you avoid borrowing money when possible?': 'Shin kana guje wa rancen kuɗi lokacin da zai yiwu?',
        'Do you feel okay taking small money risks?': 'Shin kana jin daɗi da ɗaukar ƙananan haɗarin kuɗi?',
        'Do you learn about saving or investing?': 'Shin kana koyo game da ajiye ko saka hannun jari?',
        'Do you spend less than you earn?': 'Shin kana kashe ƙasa da abin da kake samu?',
        'Do you talk about money with family or friends?': 'Shin kana tattauna game da kuɗi da dangi ko abokai?',
        ...
        'FiCore AI - Personal Finance Tools': 'FiCore AI - Kayan Aikin Kuɗi na Keɓaɓɓu',
        'Start Expense Tracker': 'Fara Mai Bibiyar Kashe Kuɗi',
        'Start Now': 'Fara Yanzu',
        'Language changed successfully': 'An canza harshe cikin nasara',
        'Invalid language selection': 'Zaɓin harshe ba daidai ba ne',
        'Failed to store authentication data': 'An kasa adana bayanan tabbatarwa',
        'Failed to save data due to Google Sheets API limit': 'An kasa adana bayanai saboda iyakancewar Google Sheets API',
        'Failed to save data due to server error': 'An kasa adana bayanai saboda kuskuren uwar garken',
        'Form validation failed. Please check your inputs.': 'Tabbatar da fom ya kasa. Da fatan za a duba bayananku.',
        'Email scheduled to be sent': 'An shirya aika imel',
        'Email notifications are disabled': 'Sanarwar imel an kashe',
        'Error generating charts': 'Kuskure wajen samar da ginshiƙai',
        'Invalid dashboard access': 'Samun dashboard ba daidai ba ne',
        'Chart failed to load. Please try again.': 'Gini ya kasa lodi. Da fatan za a sake gwadawa.',
        'No description available': 'Babu bayanin da ya wanzu',
        'Create New Record': 'Ƙirƙiri Sabon Rikodin',
        'Your asset-to-liability ratio is healthy.': 'Rabo na dukiyarka zuwa bashi yana da lafiya.',
        'Your liabilities are high. Consider strategies to reduce debt.': 'Bashinka yana da yawa. Ka ji da dabarun rage bashi.',
        'Income (₦)': 'Kudin shiga (₦)',
        'Income': 'Kudin shiga',
        'Debt (₦)': 'Bashi (₦)',
        'Asset-Liability Breakdown': 'Rarraba Dukiya da Bashi',
        'Your Score': 'Makiyinka',
        'Average Score': 'Matsakaicin Makiya',
        'Comparison to Peers': 'Kwatantawa da Abokan Hulɗa',
        'Strong Financial Health': 'Lafiyar Kuɗi Mai Ƙarfi',
        'Stable Finances': 'Kuɗi Mai Tsayayye',
        'Financial Strain': 'Matsalar Kuɗi',
        'Urgent Attention Needed': 'Ana Bukatar Kulawa Cikin Gaggawa',
        'Financial Stability Achieved!': 'An Samu Tsayayyen Kuɗi!',
        'Debt Slayer!': 'Mai Kashe Bashi!',
        'First Health Score Completed!': 'An Kammala Makiyar Lafiya ta Farko!',
        'High Value Badge': 'Alamar Daraja Mai Girma',
        'Positive Value Badge': 'Alamar Daraja Mai Kyau',
        'Maintain your positive net worth by continuing to manage liabilities and grow assets.': 'Ci gaba da kula da darajarka mai kyau ta hanyar ci gaba da sarrafa bashi da haɓaka dukiya.',
        'Your net worth is balanced. Consider increasing assets to build wealth.': 'Darajarka tana daidaitawa. Ka ji da ƙara dukiya don gina arziƙi.',
        'Focus on reducing liabilities to improve your net worth.': 'Ka mai da hankali kan rage bashi don inganta darajarka.',
        'Positive Net Worth': 'Daraja Mai Kyau',
        'Wealth Builder': 'Mai Gina Arziƙi',
        'Debt Recovery': 'Dawo da Bashi',
        'Regularly review your assets and liabilities to track progress.': 'A kai a kai ka duba dukiyarka da bashinka don bin diddigin ci gaba.',
        'Invest in low-risk assets to grow your wealth steadily.': 'Saka hannun jari a cikin dukiya mai ƙarancin haɗari don haɓaka arziƙinka a hankali.',
        'Create a plan to pay down high-interest debt first.': 'Ƙirƙiri shiri don biyan bashi mai yawan riba da farko.',
        'Personal Finance 101': 'Ilmin Kuɗi na Keɓaɓɓu 101',
        'Debt Management Basics': 'Ƙa’idodin Sarrafa Bashi',
        'Investing for Beginners': 'Saka Hannun Jari ga Masu Farawa',
        'No expense data available.': 'Babu bayanan kashe kuɗi da aka samu.',
        'Expense Breakdown by Category': 'Rarraba Kashe Kuɗi ta Nau’i',
        'Invalid due date format in bill': 'Tsarin ranar ƙarewa ba daidai ba ne a cikin lissafin',
        'Reminder date is in the past': 'Ranar tunatarwa ta wuce',
        'Failed to schedule bill reminder due to server error': 'An kasa shirya tunatarwar lissafin saboda kuskuren uwar garken',
        'Failed to send email notification': 'An kasa aika sanarwar imel',
        'Score Report Subject': 'Rahoton Makiyar Lafiyar Kuɗi ga {user_name}',
        ...
        'Keep learning! Your {personality} approach can improve with regular financial reviews.': 'Ci gaba da koyo! Tsarin {personality} ɗinka zai iya inganta tare da duba kuɗi akai-akai.',
        'Invalid dashboard access': 'Samun dashboard ba daidai ba',
        'Net Worth Calculator': 'Ƙididdigar Darajar Kuɗi',
        'Understand your financial standing and track your progress towards your goals.': 'Fahimci matsayin kuɗin ka kuma bi diddigin ci gaban ka zuwa ga manufofin ka.',
        ...
        'Total amount of money you owe — loans, debts, unpaid bills, etc.': 'Jimillar adadin kuɗin da kake bin bashi — lamuni, basussuka, kuɗin da ba a biya ba, da sauransu.',
        ...
        'Extra percentage you pay on a loan, usually per year or month. It’s usually something like 12% or 7%.': 'Ƙarin kashi da kake biya akan lamuni, yawanci a kowace shekara ko wata. Yawanci wani abu kamar 12% ko 7%.',
        'Type personal name if no business': 'Rubuta sunan mutum idan babu kasuwanci',
        'e.g. 10%': 'misali, 10%',
        'Select Individual if managing personal finances, or Business if submitting for a company.': 'Zaɓi Mutum idan kana sarrafa kuɗin kanka, ko Kasuwanci idan kana ƙaddamarwa don kamfani.',
        'Valid percentage!': 'Kashi mai inganci!',
        'Personal Finance 101': 'Ilmin Kuɗi na Mutum 101',

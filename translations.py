translations = {
    ...
    'Hausa': {
        ...
        'Fill in your name, email, and phone number. Choose your language—English or Hausa.': 'Cika sunanka, imel, da lambar waya. Zaɓi harshenka—Turanci ko Hausa.',
        'Enter your business name, or your personal name if you don’t have a business. Select if you’re an individual or a business.': 'Shigar da sunan kasuwancinka, ko sunanka na mutum idan ba ka da kasuwanci. Zaɓi idan kai mutum ne ko kasuwanci.',
        'Add your monthly money details. Hover or tap the ℹ️ icons for help on what to enter.': 'Ƙara bayanan kuɗin ka na wata-wata. Janyo ko danna alamun ℹ️ don taimako kan abin da za ka shigar.',
        'Double-check your details, then click Submit to get your financial health score!': 'Bincika bayananka sau biyu, sannan danna Sallama don samun makin lafiyar kuɗin ka!',
        ...
        'Extra percentage you pay on a loan, usually per year or month. It’s usually something like 12% or 7%.': 'Ƙarin kashi da kake biya kan lamuni, yawanci a kowace shekara ko wata. Yawanci wani abu ne kamar 12% ko 7%.',
        'Type personal name if no business': 'Rubuta sunan mutum idan ba ka da kasuwanci',
        ...
        'Select Individual if managing personal finances, or Business if submitting for a company.': 'Zaɓi Mutum idan kana sarrafa kuɗin ka na mutum, ko Kasuwanci idan kana ƙaddamarwa don kamfani.',
        ...
        'Net Worth Calculator': 'Kalkuleta na Net Worth',
        'Understand your financial standing and track your progress towards your goals.': 'Fahimci matsayin kuɗin ka kuma bibiyi ci gabanka zuwa ga burinka.',
        'Enter amounts in Naira (₦).': 'Shigar da adadin a cikin Naira (₦).',
        'Total value of everything you own — cash, property, investments, vehicles, etc.': 'Jimillar ƙimar duk abin da ka mallaka — kuɗi, dukiya, saka hannun jari, motoci, da sauransu.',
        'Total amount of money you owe — loans, debts, unpaid bills, etc.': 'Jimillar kuɗin da kake bin bashi — lamuni, basussuka, lissafin da ba a biya ba, da sauransu.',
        'Get your net worth instantly!': 'Sami net worth ɗinka nan take!',
        'e.g. 500,000': 'misali 500,000',
        'e.g. 200,000': 'misali 200,000',
        'Submit net worth form': 'Ƙaddamar da fom na net worth',
        ...
        'Choose your preferred language for the quiz. Options: English, Hausa.': 'Zaɓi harshen da ka fi so don gwajin. Zaɓuɓɓuka: Turanci, Hausa.',
        ...
        'Submit quiz form': 'Ƙaddamar da fom na gwaji',
        'Do you regularly track your income and expenses?': 'Shin kana bibiyar kuɗin shiga da kashe kuɗi akai-akai?',
        'Do you prefer saving for the future over spending on immediate desires?': 'Shin ka fi son tanadi don gaba fiye da kashewa kan abubuwan da kake so nan take?',
        ...
        'Do you have an emergency fund set aside for unexpected situations?': 'Shin kana da asusun gaggawa da aka keɓe don yanayi na bazata?',
        'Do you review your financial goals and strategies regularly?': 'Shin kana duba burin kuɗin ka da dabaru akai-akai?',
        'Emergency Fund Calculator': 'Kalkuleta na Asusun Gaggawa',
        'Protect your financial well-being from unexpected events. Calculate your ideal safety net.': 'Kare lafiyar kuɗin ka daga abubuwan da ba a zata ba. Ƙididdige hanyar tsaron ka mafi kyau.',
        'Most experts recommend saving 3-6 months of essential living expenses.': 'Yawancin ƙwararru suna ba da shawarar tanadi na watanni 3-6 na kashe kuɗin rayuwa masu mahimmanci.',
        'Recommended fund size: ₦': 'Girman asusu da aka ba da shawara: ₦',
        'Enter the total amount you spend monthly on essentials like food, rent, transport, etc.': 'Shigar da jimillar kuɗin da kake kashewa kowane wata kan abubuwan mahimmanci kamar abinci, haya, sufuri, da sauransu.',
        'Calculate Your Recommended Fund Size': 'Ƙididdige Girman Asusun da Aka Ba da Shawara',
        'Find your safety net amount now!': 'Nemo adadin hanyar tsaron ka yanzu!',
        ...
        'Take control of your finances and achieve your goals by creating a monthly budget.': 'Ɗauki iko da kuɗin ka kuma cimma burinka ta hanyar ƙirƙirar kasafin kuɗi na wata.',
        'Enter your total monthly earnings, including salary and side income.': 'Shigar da jimillar kuɗin shiga na wata, gami da albashi da kuɗin ayyukan gefe.',
        'Include rent, electricity, water, and related housing bills.': 'Haɗa haya, wutar lantarki, ruwa, da lissafin gidaje masu alaƙa.',
        'Estimate how much you spend on food monthly.': 'Ƙiyasta adadin da kake kashewa kan abinci kowane wata.',
        'Monthly cost of transport—bus, bike, taxi, or fuel.': 'Kuɗin sufuri na wata—bas, keke, tasi, ko man fetur.',
        'Include internet, airtime, clothes, or personal spending.': 'Haɗa intanet, kuɗin waya, tufafi, ko kashe kuɗin mutum.',
        'Get budgeting tips in your inbox.': 'Sami shawarwarin kasafin kuɗi a cikin akwatin imel ɗinka.',
        'e.g. 150,000': 'misali 150,000',
        ...
        'Track your daily expenses to stay on top of your finances.': 'Bibiyi kashe kuɗin ka na yau da kullum don kasancewa a kan kuɗin ka.',
        ...
        'Bill Planner': 'Mai Tsara Lissafin Kuɗi',
        'Plan and manage your upcoming bills to avoid surprises.': 'Tsara kuma sarrafa lissafinka masu zuwa don guje wa abubuwan mamaki.',
        'Enter your bill details': 'Shigar da bayanan lissafinka',
        'Bill Name': 'Sunan Lissafi',
        'e.g. Electricity Bill': 'misali Lissafin Wutar Lantarki',
        'Due Date': 'Ranar Ƙarshe',
        'Status': 'Matsayi',
        'Pending': 'Ana Jiran',
        'Completed': 'An Kammala',
        'Overdue': 'Ya Wuce Lokaci',
        'Submit Bill': 'Ƙaddamar da Lissafi',
        'Add your bill now!': 'Ƙara lissafinka yanzu!',
        'Submit bill form': 'Ƙaddamar da fom na lissafi',
        'Edit Bill': 'Gyara Lissafi',
        'Update your bill details': 'Sabunta bayanan lissafinka',
        'Update Bill': 'Sabunta Lissafi',
        'Complete Bill': 'Kammala Lissafi',
        'Mark as Paid': 'Yi Alama Kamar An Biya',
        ...
        'Access essential tools and insights to understand, manage, and grow your finances across Africa': 'Samun kayan aiki masu mahimmanci da fahimta don fahimta, sarrafawa, da haɓaka kuɗin ka a duk Afirka',
        ...
        'Provides actionable insights for better financial decisions': 'Yana ba da fahimta mai amfani don ingantacciyar yanke shawara na kuɗi',
        'Assess your financial health with a personalized score and insights': 'Tantance lafiyar kuɗin ka tare da maki na keɓaɓɓu da fahimta',
        'This tool evaluates your income, expenses, and debt to provide a health score': 'Wannan kayan aiki yana tantance kuɗin shiga, kashe kuɗi, da basussuka don ba da makin lafiya',
        'Get Started with Financial Health Score': 'Fara da Makin Lafiyar Kuɗi',
        'Calculate your net worth by evaluating your assets and liabilities': 'Ƙididdige net worth ɗinka ta hanyar tantance kadarori da basussuka',
        'Net worth is calculated as assets minus liabilities': 'Ana ƙididdige net worth a matsayin kadarori banne basussuka',
        'Get Started with Net Worth Calculator': 'Fara da Kalkuleta na Net Worth',
        'Plan your emergency fund to cover unexpected expenses': 'Tsara asusun gaggawa don biyan kashe kuɗin da ba a zata ba',
        'Aims to cover 3-6 months of expenses for financial security': 'Yana nufin ya ɗauki nauyin kashe kuɗin watanni 3-6 don tsaron kuɗi',
        ...
        'Helps you allocate your income across various expense categories': 'Yana taimaka maka wajen raba kuɗin shiga a cikin rukunan kashe kuɗi daban-daban',
        'Get Started with Weekly Budget Planner': 'Fara da Mai Tsara Kasafin Kuɗi na Mako',
        'Financial Growth Tools': 'Kayan Aikinsu na Haɓaka Kuɗi',
        'Change Language': 'Canza Harshe',
        'Go': 'Tafi',
        'Discover Your Financial Tools Below': 'Gano Kayan Aikinsu na Kuɗi a ƙasa',
        'New here? Start with your Financial Health Score to get personalized recommendations.': 'Sabon nan? Fara da Makin Lafiyar Kuɗin ka don samun shawarwari na keɓaɓɓu.',
        'Begin Financial Health Score Assessment': 'Fara Tantance Makin Lafiyar Kuɗi',
        'Begin Now': 'Fara Yanzu',
        'Track Your Finances': 'Bibiyi Kuɗin Ka',
        ...
        'First Name': 'Suna',
        'Email': 'Email',
        'Monthly Income': 'Kudin Shiga',
        'Housing Expenses': 'Kudin da ake kashewa a Gida',
        'Food Expenses': 'Kudinda ake kashewa akan Abinci',
        'Transport Expenses': 'Kudinda ake kashewa wajen Tafiye-Tafiye',
        'Other Expenses': 'Sauran Kashe kudi da babu a List',
        ...
        'Add or Update an Expense': 'Add or Update an Expense',
        'e.g. Bought groceries': 'e.g. Bought groceries',
        'e.g. 5000': 'e.g. 5000',
        'What did you spend on?': 'What did you spend on?',
        'How much did you spend? Enter in Naira (₦).': 'How much did you spend? Enter in Naira (₦).',
        'Choose the type of expense.': 'Choose the type of expense.',
        'Transaction Type': 'Transaction Type',
        'Expense': 'Expense',
        'Income': 'Income',
        'Is this money you spent or received?': 'Is this money you spent or received?',
        'Date': 'Date',
        'When did this transaction happen?': 'When did this transaction happen?',
        ...
        'Add/Edit Expense': 'Ƙara/Gyara Kashe Kuɗi',
        'Add or Update an Expense': 'Ƙara ko Sabunta Kashe Kuɗi',
        'e.g. Bought groceries': 'misali, Sayi kayan abinci',
        'e.g. 5000': 'misali, 5000',
        'What did you spend on?': 'A kan me ka kashe?',
        'How much did you spend? Enter in Naira (₦).': 'Nawa ka kashe? Shigar da shi cikin Naira (₦).',
        'Choose the type of expense.': 'Zaɓi nau’in kashe kuɗi.',
        'Transaction Type': 'Nau’in Ma’amala',
        'Expense': 'Kashe Kuɗi',
        'Income': 'Kuɗin Shiga',
        ...
        'Is this money you spent or received?': 'Wannan kuɗin ne ka kashe ko ka karɓa?',
        'Date': 'Kwanan Wata',
        'When did this transaction happen?': 'Yaushe wannan ma’amala ta faru?',
        'Save Expense': 'Ajiye Kashe Kuɗi',
        'Back to Tracker': 'Koma zuwa Mai Bibiya',
